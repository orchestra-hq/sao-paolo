...
"""
    ...
    assert get_paths_to_run(("--selector", "selector_x")) == ["models/model_a.sql"]
    selectors = get_selectors_to_run(("--selector", "selector_x"))

    assert selectors == ["concurrent_selector_repro.model_a"]
